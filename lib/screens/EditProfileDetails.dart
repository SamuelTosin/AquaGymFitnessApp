...
class EditProfileDetails extends StatefulWidget {
  static String tag = '/ProfileDetails';

  @override
  EditProfileDetailsState createState() => EditProfileDetailsState();
}

class EditProfileDetailsState extends State<EditProfileDetails> {
