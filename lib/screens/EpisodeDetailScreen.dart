            ...
            Column(
              ...
              children: [
                if (_episode.isPostRestricted.validate() && mIsLoggedIn)
                  if (_episode.restrictionSetting!.restrictType == RestrictionTypeMessage ||
                      _episode.restrictionSetting!.restrictType == RestrictionTypeTemplate ||
                      _episode.restrictionSetting!.restrictType == " ")
                    Column(
                      children: [
                        ElevatedButton(
                          onPressed: () {
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: PreferredSize(
            preferredSize: data != null && data!.isPostRestricted.validate() ? Size(context.width(), kToolbarHeight) : Size(0, 0),
            child: appBarWidget(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            headingText('${buildCommentCountText(widget.episode!.noOfComments.validate())}'),
                            16.height,
                            mIsLoggedIn
                                ? AppTextField(
                                      ...
                                      suffixIcon: IconButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          buildComment(
                                            ...
                                            widget.episode!.noOfComments = widget.episode!.noOfComments! + 1;
                                          }).catchError((error) {
