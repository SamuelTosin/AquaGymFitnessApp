...
import 'package:fitnessapp/components/VideoVolumeWidget.dart';
      ...
      child: Stack(
        ...
        children: <Widget>[
          widget.url.validate().isEmpty
              ? commonCacheImageWidget(widget.image.validate(),
              ...
              children: [
                widget.isShowTitle
                    ? Column(
                        ...
                        children: <Widget>[
                          itemTitle(
                              context, parseHtmlString(widget.title.validate()),
                              fontSize: ts_xlarge,
                              maxLine: 2,
                          ...
                          Text(
                            ...
                            style: boldTextStyle(
                                size: 10, color: textSecondaryColorGlobal),
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                          ).visible(widget.runTime.validate().isNotEmpty),
                        ],
                      )
                        .paddingOnly(left: 16, bottom: 8, top: 50, right: 16)
                        .expand()
                    : Row(
                        mainAxisSize: MainAxisSize.min,
                        children: <Widget>[
                ...
                if (widget.url.validate().isNotEmpty)
                  VideoVolumeWidget(controller: _controller),
              ],
            ),
          ),
        ],
