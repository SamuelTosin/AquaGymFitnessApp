...
class CastDetailTabWidgetState extends State<CastDetailTabWidget> {
  ...
  Future<void> init() async {
    AsyncMemoizer<List<MovieData>>()
        .runOnce(
      () => getCastMovieTvShowList(
          page: page, castId: widget.castId, type: widget.type),
    )
        .then((value) {
      ...
      children: [
        ListView.builder(
          ...
          itemBuilder: (context, index) {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    4.height,
                    Text('${language!.as} ${data.characterName.validate()}',
                        style: secondaryTextStyle(color: Colors.grey.shade500)),
                    4.height,
                    Text(data.releaseYear.validate(),
                        style: primaryTextStyle(color: Colors.grey.shade500)),
                  ],
            ...
            }, borderRadius: BorderRadius.circular(defaultRadius)).paddingAll(
                8);
          },
        ),
        NoDataWidget(
